...
(function() {
	...
	class Editable {
		constructor(element, options = {}) {
			...
			this.options = {
				...
				showbuttons: true,
				onblur: 'cancel',
				enableEscape: true, // New option to control escape key behavior
				enableEnter: true, // New option to control enter key behavior
				mode: 'popup',
				emptytext: 'Empty',
				placeholder: '',
				disabled: false,
	...
	class PopoverContainer extends AbstractContainer {
		init() {
			...
			this.arrow.className = 'popover-arrow'; // BS5 uses popover-arrow instead of editable-arrow
			...
			this.body.className = 'popover-body'; // Standard Bootstrap class
			this.innerWrapper.appendChild(this.body);
			// Create loading indicator - keep this custom since Bootstrap doesn't have a specific equivalent
			...
			this.loading.style.zIndex = '1060'; // higher than popover z-index
			...
			// Add custom class to identify as an editable container (for event handling)
	...
	class InlineContainer extends AbstractContainer {
		init() {
			...
			this.element.classList.add('position-relative', 'mb-3');
	...
	Editable.prototype.destroy = function() {
		...
		// Remove classes
		this.element.classList.remove('editable', 'text-primary', 'cursor-pointer', 'text-decoration-underline', 'editable-open', 'editable-disabled');
